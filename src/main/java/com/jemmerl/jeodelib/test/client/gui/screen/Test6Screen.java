...
public class Test6Screen extends ContainerScreen<Test6Container> {
    private final ResourceLocation GUI = new ResourceLocation(JeodeLib.MOD_ID, "textures/gui/test_gui.png");

    public Test6Screen(Test6Container screenContainer, PlayerInventory inv, ITextComponent titleIn) {
